        ...
        <form onSubmit={(e) => {
          ...
          <div className='flex gap-4 mb-7'>
            ...
            {firstName && firstName.length < 3 && (
              <p className="text-red-500 text-sm mb-5">Firstname must be at least 3 characters long</p>
            )}
            <input
              required
              className='bg-[#eeeeee] w-1/2  rounded-lg px-4 py-2 border  text-lg placeholder:text-base'
            ...
            {lastName && lastName.length < 3 && (
              <p className="text-red-500 text-sm mb-5">Lastname must be at least 3 characters long</p>
            )}
          </div>
          ...
          <div className='flex gap-4 mb-7'>
            ...
            >
              ...
              <option value="motorcycle">Bike/Scooty</option>
            </select>
          </div>
