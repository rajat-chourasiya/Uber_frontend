...
const VehiclePanel = (props) => {
    return (
        <div>
            ...
            }} className="group flex border-2 border-gray-300 mb-2 rounded-xl w-full p-3 items-center justify-between cursor-pointer transition duration-300 hover:border-yellow-400 hover:bg-yellow-300 hover:shadow-lg hover:scale-[1.008]">
