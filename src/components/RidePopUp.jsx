        ...
        <div>
            ...
            <div className='flex items-center justify-between p-3 bg-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='lg:text-lg font-medium'>{props.ride?.user.fullname.firstname + " " + props.ride?.user.fullname.lastname}</h2>
                </div>
                <h5 className='lg:text-lg font-semibold w-[50%] text-right'> {props.ride?.distance || '...'} ({props.ride?.duration || 'ETA unknown'})</h5>
            </div>
